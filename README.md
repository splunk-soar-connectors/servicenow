...
**extract_ips** | optional | boolean | Extract IP addresses (IPv4 and IPv6) from ingested issues |
**extract_hashes** | optional | boolean | Extract file hashes (MD5, SHA1, SHA256) from ingested issues |
**extract_urls** | optional | boolean | Extract URLs from ingested issues |
...
[list categories](#action-list-categories) - Get a list of service categories <br>
...
Users can provide a valid ticket number in the 'id' parameter or check the 'is_sys_id' parameter and provide a valid <b>SYS ID</b> in the 'id' parameter. Users can get the <b>SYS ID</b> value for any ticket from the results of the <b>List Tickets</b> action run. For 'comment' parameter, users can provide new line(\\n), single quote(\\'), double quote(\\\\") and backspace(\\b) as escape sequences.
...
action_result.parameter.table_name | string | `servicenow table` | |
action_result.parameter.id | string | `servicenow ticket sysid` `servicenow ticket number` | |
action_result.parameter.comment | string | | |
action_result.parameter.is_sys_id | boolean | | |
...
Users can provide a valid ticket number in the 'id' parameter or check the 'is_sys_id' parameter and provide a valid <b>SYS ID</b> in the 'id' parameter. Users can get the <b>SYS ID</b> value for any ticket from the results of the <b>List Tickets</b> action run. For 'work_note' parameter, users can provide new line(\\n), single quote(\\'), double quote(\\\\") and backspace(\\b) as escape sequences.
...
action_result.parameter.table_name | string | `servicenow table` | |
action_result.parameter.id | string | `servicenow ticket sysid` `servicenow ticket number` | |
action_result.parameter.work_note | string | | |
action_result.parameter.is_sys_id | boolean | | |
action_result.data.\*.number | string | `servicenow ticket number` | INC0000001 |
action_result.data.\*.short_description | string | | My computer is not detecting the headphone device |
action_result.data.\*.sys_id | string | `servicenow ticket sysid` `md5` | |
...
action_result.status | string | | success failure |
action_result.message | string | | |
action_result.parameter.short_description | string | | |
action_result.parameter.table | string | `servicenow table` | |
...
action_result.data.\*.attachment_details.\*.hash | string | | |
...
action_result.data.\*.catalogs.\*.sys_id | string | `servicenow catalog sys id` `md5` | |
...
action_result.data.\*.variables.\*.id | string | `md5` | |
...
action_result.status | string | | success failure |
action_result.message | string | | |
action_result.parameter.sys_id | string | `servicenow catalog sys id` `md5` | |
...
action_result.data.\*.items.\*.mandatory_attachment | string | | false |
...
action_result.data.\*.items.\*.sc_catalogs | string | | |
...
action_result.data.\*.work_notes_list | string | | |
action_result.data.\*.work_start | string | | |
action_result.data.\*.comments_section.\* | string | | |
action_result.data.\*.worknotes_section.\* | string | | |
action_result.summary.queried_ticket_id | string | `servicenow ticket sysid` `md5` | |
summary.total_objects | numeric | | 1 |
summary.total_objects_successful | numeric | | 1 |
...
action_result.summary.num_variables | numeric | | 1 2 5 |
summary.total_objects | numeric | | 1 |
summary.total_objects_successful | numeric | | 1 |
...
action_result.status | string | | success failure |
action_result.message | string | | |
action_result.parameter.catalog_sys_id | string | `servicenow catalog sys id` `md5` | |
...
action_result.data.\*.work_notes_list | string | | |
action_result.data.\*.work_start | string | | |
action_result.summary.total_tickets | numeric | | 10 50 100 |
summary.total_objects | numeric | | 1 |
summary.total_objects_successful | numeric | | 1 |
...
action_result.message | string | | |
action_result.parameter.sys_id | string | `servicenow item sys id` `md5` | |
action_result.parameter.variables | string | | |
action_result.parameter.quantity | numeric | | |
...
action_result.status | string | | success failure |
action_result.message | string | | |
action_result.parameter.sysparm_term | string | | |
action_result.parameter.sysparm_search_sources | string | `servicenow ticket sysid` | |
...
action_result.data.\*.search_results.\*.records.\*.data.caller_id.display | string | | |
action_result.data.\*.search_results.\*.records.\*.data.caller_id.value | string | | |
action_result.data.\*.search_results.\*.records.\*.data.category.display | string | | |
action_result.data.\*.search_results.\*.records.\*.data.category.value | string | | |
...
action_result.data.\*.search_results.\*.records.\*.data.number.display | string | | |
action_result.data.\*.search_results.\*.records.\*.data.number.value | string | | |
action_result.data.\*.search_results.\*.records.\*.data.opened_at.display | string | | |
action_result.data.\*.search_results.\*.records.\*.data.opened_at.value | string | | |
action_result.data.\*.search_results.\*.records.\*.data.priority.display | string | | |
action_result.data.\*.search_results.\*.records.\*.data.priority.value | string | | |
action_result.data.\*.search_results.\*.records.\*.data.related_incidents.display | string | | |
action_result.data.\*.search_results.\*.records.\*.data.related_incidents.value | string | | |
action_result.data.\*.search_results.\*.records.\*.data.resolution_code.display | string | | |
action_result.data.\*.search_results.\*.records.\*.data.resolution_code.value | string | | |
action_result.data.\*.search_results.\*.records.\*.data.state.display | string | | |
action_result.data.\*.search_results.\*.records.\*.data.state.value | string | | |
action_result.data.\*.search_results.\*.records.\*.data.sys_id.display | string | | |
action_result.data.\*.search_results.\*.records.\*.data.sys_id.value | string | | |
...
action_result.data.\*.sources.\*.name.display | string | | |
action_result.data.\*.sources.\*.name.value | string | | |
...
action_result.summary.total_records | numeric | | 10 50 100 |
summary.total_objects | numeric | | 1 |
summary.total_objects_successful | numeric | | 1 |
