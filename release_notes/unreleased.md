...
* Updated scheduled polling to use UTC checkpoints, including successful empty polls, while retaining the configured timezone only for legacy checkpoint migration and compatibility state.
