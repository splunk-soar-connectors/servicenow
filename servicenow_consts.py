...
SERVICENOW_JSON_OAUTH_GRANT_TYPE = "oauth_grant_type"
...
SERVICENOW_DEFAULT_REQUEST_TIMEOUT = 30

SERVICENOW_DATETIME_FORMAT = "%Y-%m-%d %H:%M:%S"

SERVICENOW_TOKEN_STRING = "oauth_token"
SERVICENOW_STATE_IS_ENCRYPTED = "is_encrypted"
SERVICENOW_STATE_OAUTH_CLIENT_ID = "oauth_client_id"
SERVICENOW_STATE_OAUTH_GRANT_TYPE = "oauth_grant_type"
...
SERVICENOW_OAUTH_GRANT_TYPE_PASSWORD = "password"
SERVICENOW_OAUTH_GRANT_TYPE_CLIENT_CREDENTIALS = "client_credentials"
SERVICENOW_OAUTH_GRANT_TYPES = {
    SERVICENOW_OAUTH_GRANT_TYPE_PASSWORD,
    SERVICENOW_OAUTH_GRANT_TYPE_CLIENT_CREDENTIALS,
}
